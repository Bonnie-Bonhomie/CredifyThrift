...
class SavingBox extends StatelessWidget {
  const SavingBox({super.key, required this.appModel, required this.saving});
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text.rich(
                TextSpan(
                  text: appModel.formatCurrNoKobo(saving.paidAmount),
                ...
                child: TweenAnimationBuilder<double>(
                  ...
                  builder: (context, value, child) {
                    return GradientProgressBar(
                      progress: saving.percent,
                      color: savingState.color,
                    );
                  },
                ),
              ),
              ...
              Row(
                children: [
                  Icon(savingState.icon, color: savingState.color),
...
class SavingCard extends StatelessWidget {
  const SavingCard({super.key, required this.appModel, required this.saving});
                  ...
                  Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text('Amount paid', style: CredTextStyle.bs3),
                      ),
                      Text.rich(
                        TextSpan(
                          text: appModel.formatCurrNoKobo(saving.paidAmount),
